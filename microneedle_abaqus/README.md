...
> **실행 검증 결과 (Abaqus 2025.HF4, 2026-07-14):** 잡 COMPLETED.
> 고유값 = 최저모드 **0.21884 N** (모드 1=2, 3=4 쌍중복 → 원형단면 기둥의
> 정상 거동). 즉 **P_cr ≈ 0.219 N**. Euler 개략치(~0.5 N)보다 낮은 것은
> 하중이 걸리는 테이퍼 첨두(r≈0.028)가 좌굴을 지배하기 때문이며 정상.
